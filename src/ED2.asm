...
; Q = Quitter.
DONJON_Q:
	LBRA $F000		; Redémarrage à froid du MO5.
...
GAME_END:
	BSZ $8680-GAME_END ; Remplissage de zéros jusqu'à 867F inclus.
...
; Le registre DP n'est pas utilisé au cas où il serait différent de $20.
...
Pack_loop
    ...
    cmpx #$A000
    beq Pack_end        ; si on arrive à $A000 alors fin de chargement
...
; du fichier EXCEL PACKMAPS.xlsm
	...
	IFEQ PACKM-1
		INCLUDEBIN PACKM1.bin	; A sélectionner pour la compilation du pack 1.
	ENDC
	IFEQ PACKM-2
		INCLUDEBIN PACKM2.bin	; A sélectionner pour la compilation du pack 2.
	ENDC
	IFEQ PACKM-3
		INCLUDEBIN PACKM3.bin	; A sélectionner pour la compilation du pack 3.	
	ENDC
