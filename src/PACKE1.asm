...
; directive "INCLUDE .\PACKE1.asm", afin d'être compilé. C'est ED2PACK1.vbs qui
; se charge de la compilation et de l'extraction du fichier PACKE1.BIN à partir
; du code compilé ED2PACK1.BIN.
;
...
DEN_COUL00	FCB $10			; rouge (1) sur fond noir (0).
DEN_COUL01	FCB $17			; rouge (1) sur fond blanc (7).
DEN_COUL02	FCB $51			; magenta (5) sur fond rouge (1).
DEN_COUL03	FCB $10			; rouge (1) sur fond noir (0).
...
E02_G06_ATK:
	...
	LDD #$1118		; A = rouge sur fond rouge. B = 24 pour les sauts de ligne.
	LDX #SCROFFSET+$0002
	LBSR G2_R1_12x16
	LDX #SCROFFSET+$0822
	LBSR G2_R1_16x16
	LDX #SCROFFSET+$1222
	LBSR G2_R1_15x16
	LDD #$001C		; A = noir sur fond noir. B = 26 pour les sauts de ligne.	
	LDX #SCROFFSET+$0AA4
	LBSR G2_R1_48x12
	LDD #$1111		; A = B = rouge sur fond rouge.
	LDX #SCROFFSET+$01E8	
	LBSR DISPLAY_ABBA_20
	LDA #$41		; A = bleu sur fond rouge.
	LBSR DISPLAY_ABBA_20
...
E02_G06C:
	LDD #$0101		; A = B = Noir sur fond rouge.
	BRA E02_G06_2

; Initialisation pour les fantômes devant un mur W13.
E02_G06B:
	LDD #$0141		; A = Noir sur fond rouge. B = bleu sur fond rouge.
	BRA E02_G06_2

; Initialisation pour les fantômes devant un mur W6.
E02_G06A:
	LDD #$4141		; A = B = bleu sur fond rouge.
...
E02_G06_2:
	...
	LBSR G2_R1_8x4
	LDD #$4741		; A = bleu sur fond blanc. B = bleu sur fond rouge.
	LBSR DISPLAY_ABBA_6
	LDD #$1125		; A = rouge sur fond rouge.	B = 37 pour les sauts de ligne.	
	LBSR G2_R1_16x4
	LDA >VARDB2
	LBSR G2_R1_5x4	
...
E02_G14B:
	LDD #$4101		; A = bleu sur fond rouge. B = noir sur fond rouge.
	BRA E02_G14_2
...
E02_G10_R2:
	...
	PSHS X
	LDD #$4128		; A = bleu sur fond rouge. B = 40 pour les sauts de ligne.
	LBSR DISPLAY_A_17
	LDA >VARDB1
	LBSR DISPLAY_A_15	
	PULS X
...
E02_G18_4:
	...
	STA	,X
	ABX
	LDA #$71		; blanc sur fond rouge
	LBSR DISPLAY_A_5
	LDA #$74		; blanc sur fond bleu
	STA	,X
	ABX
	STA	,X
	ABX
...
; Sous-routine de tuile codée.
E03_G06:
	LDA #$05		; A = Noir sur fond magenta.
...
E03_G06_2:
	...
	BSR DISPLAY_ABBA_7
	BSR DISPLAY_ABBA_32
	ORB #$F0		; B = Orange sur fond bleu ou magenta.	
	BSR DISPLAY_ABBA_2
	LDA >VARDB3
	LDB #$0F		; B = Noir sur fond orange.
	BSR DISPLAY_ABBA_5
...
E03_G10_R2:
	...
	LDA >VARDB3		; A = couleur de robe du spectre (noir / bleu ou magenta).
	LBSR DISPLAY_A_24
	ORA #$F0		; A = orange sur fond bleu ou magenta.
	STA	,X
	ABX
...
E05_G06_ATK:
	...
	LDA #$80		; A = gris sur fond noir.
	LBSR G2_R1_40x8
	LDX #SCROFFSET+$0EB9 ; X pointe les yeux de l'araignée.
	LDD #$1028		; A = rouge sur fond noir. B = 40 pour les sauts de ligne.
	LBSR DISPLAY_2A_6
	LDA #$70		; A = blanc sur fond noir	
	LBSR DISPLAY_2A_8
...
E05_G06:
	...
	LBSR VIDEOC_A	; Sélection video couleur.	
E05_G06_1:
	LDD #$8024		; A = gris sur fond noir. B = 36 pour les sauts de ligne.
