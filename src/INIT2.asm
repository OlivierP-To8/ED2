...
INIT2:
	...
	LDA #$BE		; A = Bleu (12) sur fond bleu ciel (14).
	...
	LDY #$1FE0		; Y pointe les données d'initialisation dans la mémoire couleur.
...
INIT2_FIN:
	BSZ $2700-INIT2_FIN	; Remplissage de zéros jusqu'à $26FF inclus.