...
INIT1:
	...
	LDY #$1FC0		; Y pointe les codes de touche dans la vidéo couleur.
...
INIT1_FIN:
	BSZ $2700-INIT1_FIN	; Remplissage de zéros jusqu'à $26FF inclus.