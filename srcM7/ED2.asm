...
;******************************************************************************
	...
	IFEQ INIT-1
		INCLUDE ../srcTO/INIT1.asm		; A sélectionner pour la compilation du pack 1.
	ENDC
	IFEQ INIT-2
		INCLUDE ../srcTO/INIT2.asm		; A sélectionner pour la compilation du pack 2.
	ENDC
	IFEQ INIT-3
		INCLUDE ../srcTO/INIT3.asm		; A sélectionner pour la compilation du pack 2.
	ENDC
...
PACK_LOAD
    ...
    ; copie d'EXO2 en [$6300-$6452]
    ldu #EXO2+$152
    ldx #$2F52      ; [$6300-$6452] stocké en [$2E00-$2F52]
CopyEXO2
    leax -2,x
    ldd ,x
    pshu d
...
ExecOutro
	jmp >$0030		; Exécution de l'outro depuis la ROM
...
LoadPack
    ...
    ; copie de INIT.DAT
    ldu #$6700
    ldx #$4000      ; [$6600-$6700] stocké en [$3F00-$4000]
CopyINIT
    leax -2,x
    ldd ,x
    pshu d
    ...
    ldu #$3EFF      ; dernier octet du PACK.DAT.exo2
    ldy #$E000      ; dernier octet de la destination
...
GAME_END:
	BSZ $C6E5-GAME_END ; Remplissage de zéros jusqu'à C6E4 inclus.


; ED2Restart doit être < à $C700 car il met à jour ce qui est >= $C700
...
;	ORG $C710		; Pack à charger entre $C710 et $D9BF
	...
	IFEQ PACKE-1
		INCLUDE ../srcTO/PACKE1.asm	; A sélectionner pour la compilation du pack 1.
	ENDC
	IFEQ PACKE-2
		INCLUDE ../srcTO/PACKE2.asm	; A sélectionner pour la compilation du pack 2.
	ENDC
	IFEQ PACKE-3
		INCLUDE ../srcTO/PACKE3.asm	; A sélectionner pour la compilation du pack 3.
	ENDC
...
; du fichier EXCEL PACKMAPS.xlsm
	...
	ENDC
	IFEQ PACKM-3
		INCLUDEBIN ../srcTO/PACKM3TO.bin	; A sélectionner pour la compilation du pack 3.
	ENDC
