...
EXO2    EQU $2300
; Adresses page 1
IMG_DEBUT1_FORME_FIN    EQU $BFEE
IMG_DEBUT2_FORME_FIN    EQU $BFF0
IMG_MENU_FORME_FIN      EQU $BFF2
IMG_TITRE_FORME_FIN     EQU $BFF4
IMG_TITRE_FOND_FIN      EQU $BFF6
IMG_FORME_FIN           EQU $BFF8
; Adresses page 2
SAMPLE_EXO2_FIN         EQU $BFFA
