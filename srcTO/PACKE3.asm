...
; directive "INCLUDE PACKE3.asm", afin d'être compilé.
;
...
DEN_COUL00	FCB	0			; -
DEN_COUL01	FCB c51			; magenta (5) sur fond rouge (1).
DEN_COUL02	FCB c10			; rouge (1) sur fond noir (0).
DEN_COUL03	FCB c1B			; rouge (1) sur fond jaune paille (11).
...
E01_G06_ATK:
	...
	LDA #c81		; A = gris sur fond rouge.
	LBSR G2_R1_40x8
	LDX #SCROFFSET+$0EB9 ; X pointe les yeux de l'araignée.
	LDD #c0128		; A = noir sur fond rouge. B = 40 pour les sauts de ligne.
	LBSR DISPLAY_2A_6
...
E01_G06:
	...
	LBSR VIDEOC_A	; Sélection video couleur.
E01_G06_1:
	LDD #c8124		; A = gris sur fond rouge. B = 36 pour les sauts de ligne.
...
E01_G09_2:
	LBSR VIDEOC_A	; Sélection video couleur.
	PSHS X
	LDD #c1828		; A = rouge sur fond gris. B = 40 pour les sauts de ligne.
	LBSR DISPLAY_A_14
	PULS X
...
E02_G06_2:
	...
	BSR DISPLAY_ABBA_8
	LDD #c0303		; A = B = Noir sur fond jaune.
	BSR DISPLAY_ABBA_7
	BSR DISPLAY_ABBA_32
	LDB #cF3		; B = Orange sur fond jaune.
	BSR DISPLAY_ABBA_2
	LDD #c080F		; A = Noir sur fond gris. B = Noir sur fond orange.
	BSR DISPLAY_ABBA_5
...
E04_G18:
	...
	LDA #c10		; Sinon B21 : A = rouge fond noir.
...
E04_G21:
	...
	LDA #c10		; Sinon B24 : A = rouge sur fond noir.
...
E05_G21:
	...
	LDA #c00			; Sinon B24 : A = noir sur fond noir.
...
E05_G18:
	...
	LDA #c00		; Sinon B21 : A = noir sur fond noir.
...
E05_G23:
	...
	LDA #c00		; Sinon B25 : A = noir sur fond noir.
