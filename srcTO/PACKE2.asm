...
; directive "INCLUDE PACKE2.asm", afin d'être compilé.
;
...
DEN_COUL00	FCB c50			; magenta (5) sur fond noir (0).
DEN_COUL01	FCB c1B			; rouge (1) sur fond jaune paille (11).
DEN_COUL02	FCB c10			; rouge (1) sur fond noir (0).
DEN_COUL03	FCB c12			; rouge (1) sur fond vert vif (2).
DEN_COUL04	FCB c1D			; rouge (1) sur fond rose (13).
DEN_COUL05	FCB c10			; rouge (1) sur fond noir (0).
...
E05COUL	FCB c04		; Couleur E05 normale = noir sur fond bleu
...
E02_G06_0:
	...
	LDB #c17		; B = rouge sur fond blanc.
	LDA >W49D		; Le mur W49 est-il affiché?
	BNE E02_G06_2	; Si oui => E02_G06_2

	LDB #c18		; B = $18 = rouge sur fond gris.
	LDA >W25D		; Le mur W25 est-il affiché?
	BNE E02_G06_2	; Si oui => E02_G06_2.

	LDB #c10		; Sinon fond B25 : B = rouge sur fond noir.
	BRA E02_G06_2
...
E02_G14_INI:
	...
	;INCB			; B = $x8 = fond gris.
	EORB #%10000111 ; conversion saturée/pastel TO
...
E02_G06_DATA_C1:
	FCB c1B		; Couleurs communes colonnes 1 et 5
	FCB c1B
	FCB c1B
	FCB c1B
	FCB c10
...
E03_G06_ATK:
	LBSR VIDEOC_A	; Sélection vidéo couleur.
	LDD #c3328		; A = jaune vif / jaune vif. B = 40 pour les sauts de ligne
...
E03_G06:
	...
	LDB >MAPCOULC
	ANDB #%10000111	; B = noir sur fond de mur courant.
	EORB #%01000000 ; conversion saturée/pastel TO
...
E03_G06_ATKPL:
	FCB c33,cBB,c77,c3B,cB7

E03_G06_DATA_C2:
	FCB c0A		; Couleurs des colonnes 2 et 4
	FCB c0A
	FCB c07
	FCB c07
	FCB c71
...
E03_G06_DATA_C3:
	FCB c02		; Couleurs de la colonne 3
	FCB cA2
	FCB c2A
	FCB cA2
	FCB c2A
...
E04_G06_ATK1A:
	...
	LDA #c55			; A = magenta sur fond magenta.
...
E04_G06_ATK6:
	...
	BSR E04_G06_ATK6A
	LDA #c00			; A = noir sur fond noir
	LDX #SCROFFSET+$0286 ; X pointe ligne 17, 8ème colonne
	LBSR DISPLAY_A_8	; Lignes 17 à 24
	LEAX -313,X
	LBSR DISPLAY_A_8	; Lignes 17 à 24
	RTS
...
E04_G06_ATK6A:
	...
	LBSR DISPLAY_2A_8	; Lignes 17 à 24
	LDA #c00			; A = noir sur fond noir
	...
	LDA #cDD			; A = rose sur fond rose.
	LBSR DISPLAY_2A_2	; Lignes 129 à 131
	STA ,X
	STA 1,X
	RTS
...
E04_G06:
	...
	LBSR VIDEOC_A	; Sélection vidéo couleur.
	LDD #c5828		; A = mauve sur fond gris. B = 40 pour les sauts de ligne.
...
E04_G06_R1_1:
	...
	LDA #c5D		; A = mauve sur fond rose
	LBSR DISPLAY_A_13 ; Lignes 10 à 22
	LDA #c58		; A = mauve sur fond gris. 
	STA ,X			; Ligne 23
	RTS
...
E04_G18_2:
	LBSR VIDEOC_A	; Sélection vidéo couleur.
	LDD #c8528		; A = gris sur fond mauve. B = 40 pour les sauts de ligne.
	STA ,X			; Ligne 1
	ABX
	STA ,X			; Ligne 2
	ABX
	LDA #c05		; A = noir sur fond mauve.
	LBSR DISPLAY_A_5 ; Lignes 2 à 6
...
E05_G06_ATK_R1:
	...
	LBSR VIDEOC_A	; Sélection vidéo couleur.
	LDD #c3028		; A = jaune vif sur fond noir. B = 40 pour les sauts de ligne.
...
E05_G06_2:
	STA >VARDB1
	STA >VARDB5
	ORA #$48		; A = rouge sur fond blanc ou gris
	STA >VARDB2
	BRA E05_G06_4
...
E05_G06_4:
	...
	LDA #c01
	lBSR DISPLAY_A_2 ; Lignes 13 et 14
...
E05_G06_R2:
	...
	ANDA #%10000111	; A = noir sur fond xxx.
	EORA #%01000000 ; conversion saturée/pastel TO
	STA ,X			; Ligne 13
	ABX
	LDA #c08		; A = noir sur fond gris.
	STA ,X			; Ligne 14
